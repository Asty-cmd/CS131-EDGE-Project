    ...
    if result.face_landmarks:
        for face_landmarks in result.face_landmarks:
            ...
            mp_drawing.draw_landmarks(
                ...
                connections=convert_connections(vision.FaceLandmarksConnections.FACE_LANDMARKS_TESSELATION),
            ...
            mp_drawing.draw_landmarks(
                image=annotated_image,
                landmark_list=face_landmarks_proto,
                connections=convert_connections(vision.FaceLandmarksConnections.FACE_LANDMARKS_CONTOURS),
                landmark_drawing_spec=None,
            ...
            mp_drawing.draw_landmarks(
                image=annotated_image,
                landmark_list=face_landmarks_proto,
                connections=convert_connections(vision.FaceLandmarksConnections.FACE_LANDMARKS_LEFT_IRIS),
                landmark_drawing_spec=None,
            ...
            mp_drawing.draw_landmarks(
                image=annotated_image,
                landmark_list=face_landmarks_proto,
                connections=convert_connections(vision.FaceLandmarksConnections.FACE_LANDMARKS_RIGHT_IRIS),
                landmark_drawing_spec=None, 
                connection_drawing_spec=mp_styles.get_default_face_mesh_iris_connections_style())
